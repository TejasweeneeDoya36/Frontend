    ...
    methods:{
        ...
        login: async function(){
            ...
            if (this.validateLogin()){
                ...
                try{
                    ...
                    const response = await fetch ("https://node-js-express-js-xbto.onrender.com/api/login",{
                        method:"POST",
        ...
        signup: async function(){
            ...
            if (this.validateSignup()){
                ...
                try{
                    ...
                    const response = await fetch ("https://node-js-express-js-xbto.onrender.com/api/signup",{
                        method: "POST",
                        headers:{"Content-Type":"application/json"},
                        body: JSON.stringify({
        ...
        fetchUserCount: async function() {
            try{
                ...
                const response = await fetch('https://node-js-express-js-xbto.onrender.com/api/user-count');
