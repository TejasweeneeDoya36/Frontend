    ...
    methods:{
        ...
        fetchLessons: async function () {
            try{
                ...
                const response= await fetch('https://node-js-express-js-xbto.onrender.com/api/lessons');
        ...
        handleSearch:function(){
            ...
            this.searchTimeout = setTimeout(async ()=>{
                try{
                    ...
                    const response = await fetch (`https://node-js-express-js-xbto.onrender.com/api/search?q=${encodeURIComponent(query)}`);
                    const data = await response.json();
        ...
        handleCheckout: async function() {
            ...
            try{
                ...
                const orderResponse = await fetch ('https://node-js-express-js-xbto.onrender.com/api/orders',{
                    method: 'POST',
            ...
            try{
                ...
                const updateResponse = await fetch ('https://node-js-express-js-xbto.onrender.com/api/update-spaces',{
                    method: 'PUT',
                    headers: {'Content-Type':'application/json'},
